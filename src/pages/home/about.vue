  ...
  <div class="ttOfferCont">
    ...
    <div class="aboutBot">
      ...
      <div class="lineAb">
        ...
        <p class="linP">泰霆云Taiting Cloud 是泰霆科技（重庆）有限公司旗下的一款在智能建筑工程管理系统泰霆云致力于为中小型建筑企业打破过去大而全的模式，充分利用云平台信息资源，帮助企业内部实现管理的革新，同时对企业的发展规划打下了牢固的地基。解决企业管理述求，提高企业办公效率、实时可视化管理、加大项目成本控制及项目进度监控。让企业以简单、安全、高效的管理的方式，去创造更高的价值。</p>
      </div>
    </div>
    <div class="conTact">
